<template>
  <div class="mb-6">
    ...
    <p>
      For inquiries about our professional writing services and to receive
      personalized pricing information tailored to your needs, please don't
      hesitate to reach out. Your pathway to excellence begins with a
      conversation.
    </p>
    ...
    <div class="flex justify-content-center">
      ...
      <div>
        <a href="mailto: trackerguy2@gmail.com">trackerguy2@gmail.com</a>
      </div>
    </div>
  </div>
</template>
